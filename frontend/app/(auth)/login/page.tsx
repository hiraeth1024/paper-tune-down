        ...
        <div className="relative flex flex-col justify-between p-12 xl:p-16 w-full">
          <div>
            <a href="/" className="flex items-center gap-3 group">
              <img src="/favicon.svg" alt="PaperTune" className="w-10 h-10 xl:w-11 xl:h-11 rounded-xl shadow-lg transition-transform group-hover:scale-105" />
              <div>
                <span className="text-2xl xl:text-3xl font-bold text-white tracking-tight font-[family-name:var(--font-display)]">
                  PaperTune
                </span>
                <p className="text-brand-200 text-sm xl:text-base mt-0.5 leading-relaxed">
                  智能论文降重助手
                </p>
              </div>
            </a>
          ...
          <div className="space-y-4">
            <a
              ...
              className="flex items-center gap-2.5 text-brand-200/70 hover:text-white transition-colors group"
            >
              ...
              <svg className="w-3.5 h-3.5 opacity-50 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="lg:hidden text-center mb-10">
            <a href="/" className="inline-flex items-center gap-2.5">
              <img src="/favicon.svg" alt="PaperTune" className="w-8 h-8 rounded-lg shadow-md" />
              <span className="text-2xl font-bold text-brand-600 tracking-tight font-[family-name:var(--font-display)]">
                PaperTune
              </span>
            </a>
          </div>
